...
export const JOB_ROLES: JobRole[] = [
  // LOGISTICS & SUPPLY CHAIN ROLES
  {
    ...
    image: '/assets/images/animated.jpeg',
    imageAlt: 'Professional warehouse associate in safety vest',
    modules: [
      {
        id: 'wa-mod-1',
        ...
        videoDuration: '11:30',
        videoUrl: 'https://player.mediadelivery.net/embed/734914/90e161f5-96ec-40d0-81fe-2143545e495d?autoplay=true&loop=false&muted=true&preload=true&responsive=true',
  ...
  },
  {
    ...
    fullDescription: 'Become a certified Inbound Associate trained on Purchase Order verification, seal integrity, defect sampling tables (AQL), and digital NCR reporting.',
    ...
    hasPractical: true,
    practicalHours: 8,
    careerPath: ['Inbound Associate', 'Shift Floor QC Lead', 'Quality & Compliance Manager'],
    skillsGained: ['Bill of Lading Audits', 'AQL Sampling', 'Seal Verification', 'Quarantine Handling'],
    image: '/assets/images/inbound dp.jpeg',
    imageAlt: 'Inbound Associate warehouse check',
    modules: [
      {
        id: 'qc-mod-1',
  ...
  },
  {
    ...
    imageAlt: 'Inventory & Staging Specialist stock counting',
    modules: [
      {
        id: 'inv-mod-1',
  ...
  },
  {
    ...
    image: '/assets/images/outbound.jpeg',
    imageAlt: 'Dispatch & Fleet Coordinator loading dock',
    modules: [
      {
        id: 'dfc-mod-1',
  ...
  // QUICK COMMERCE ROLES
  {
    ...
    image: '/assets/images/Picker dp.jpeg',
    imageAlt: 'Dark Store Picker & Packer',
    modules: [
      {
        id: 'dsp-mod-1',
