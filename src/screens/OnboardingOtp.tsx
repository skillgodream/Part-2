...
export function OnboardingOtpScreen() {
  ...
  return (
    <div className="min-h-screen bg-purple-50 flex flex-col justify-between selection:bg-blue-600 selection:text-white" id="onboarding-otp-screen">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-0">
        ...
        <div className="w-full h-full sm:h-auto sm:max-w-lg bg-white rounded-t-3xl sm:rounded-2xl border-t sm:border border-slate-200/80 p-6 sm:p-9 shadow-sm flex flex-col">
          
          {/* Header Title & Subtitle (Removed) */}
          <div className="mb-8" />
